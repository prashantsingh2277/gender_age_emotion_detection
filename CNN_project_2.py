...
training_set = train_datagen.flow_from_directory('dataset3/age_prediction/train',
                                                 target_size = (64, 64),
                                                 batch_size = 32,
...
test_set = test_datagen.flow_from_directory('dataset3/age_prediction/test',
                                            target_size = (64, 64),
                                            batch_size = 32,
                                            class_mode = 'categorical')
