...
training_set = train_datagen.flow_from_directory('dataset2/training_dataset',
                                                 target_size = (64, 64),
                                                 batch_size = 32,
                                                 class_mode = 'binary')
...
test_set = test_datagen.flow_from_directory('dataset2/testing_dataset',
                                            target_size = (64, 64),
                                            batch_size = 32,
                                            class_mode = 'binary')
...
cnn.save_weights('my_cnn_model_weights.h5')
...
cnn.load_weights('my_cnn_model_weights.h5')
